...
// 3. rbegin() – Returns a reverse iterator pointing to the last element in the vector (reverse beginning). It moves 
// from last to first element
// 4. rend() – Returns a reverse iterator pointing to the theoretical element preceding the first element in the 
// vector (considered as reverse end)
// 5. cbegin() – Returns a constant iterator pointing to the first element in the vector.
// 6. cend() – Returns a constant iterator pointing to the theoretical element that follows the last element in the
//  vector.
